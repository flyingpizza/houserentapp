...
from app.rest.schemas.calls import HousePredictionPayload, HousePredictionResult, payload_to_list
...
class HousePriceModel(object):
    ...
    def __init__(self, path='sample_model/lin_reg_california_housing_model.joblib'):
        self.path = path
